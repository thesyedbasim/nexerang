...
const Header = () => {
	const headerSection: MutableRefObject<SectionCopyWithImage> = useRef({
		...
		body: 'Nexerang is a Website Development and Designing Agency. We Enhance and Grow your Online Presence and Conversion Rates. We build Fast, Functional and Beautiful Websites to help you with that.',
		image: {
